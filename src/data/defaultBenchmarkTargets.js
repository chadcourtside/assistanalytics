...
export const DEFAULT_BENCHMARK_TARGETS = [
  ...
  { metricKey: 'hqpa', label: 'HQPA', target4: '1 - 2', target12: '2 - 4', isKey: true },
  { metricKey: 'secondAst', label: '2nd Assists', target4: '0 - 1', target12: '1+' },
  { metricKey: 'screenAst', label: 'Screen Assists', target4: '0 - 1', target12: '1+' },
  ...
  { metricKey: 'oreb', label: 'Offensive Rebounds', target4: '0 - 1', target12: '1 - 2' },
  { metricKey: 'blk', label: 'Blocks', target4: '0 - 1', target12: '1+' },
  { metricKey: 'defl', label: 'Deflections', target4: '2 - 4', target12: '4+' },
  { metricKey: 'ftPct', label: 'FT %', target4: '65%+', target12: '70%+', format: '%', isKey: true },
  { metricKey: 'efg', label: 'eFG%', target4: '45%+', target12: '48%+', format: '%' },
